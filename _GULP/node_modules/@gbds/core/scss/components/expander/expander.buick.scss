...
.gb-expander {
	...
	>.gb-expander-btn {
		@include e.expander-btn(
			...
			1px,
			1.3,
			calc(0.8999 * #{com.$gmux-base-font}) calc(1.5 * #{com.$gmux-base-font}),
		...
		@include bp.medium-and-above {
			...
			padding: calc(0.9375 * #{com.$gmux-base-font}) calc(1.5625 * #{com.$gmux-base-font});
			&::before {
		...
		@include bp.large-and-above {
			...
			padding: calc(0.975 * #{com.$gmux-base-font}) calc(1.625 * #{com.$gmux-base-font});
	...
	&[data-disabled] {
		>.gb-expander-btn {
			@include e.expander-btn-disabled(0 0 calc(0.9375 * #{com.$gmux-base-font}), null);

				@include bp.medium-and-above {
					padding: 0 0 calc(0.9765 * #{com.$gmux-base-font});
				}
	...
	@include bp.medium-only {
		...
		&.gb-disabled-med {
			>.gb-expander-btn {
				@include e.expander-btn-disabled(0 0 calc(0.9765 * #{com.$gmux-base-font}), null);
			}
